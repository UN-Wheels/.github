...
- **Source:**
- **Stimulus:**
- **Artifact:** Componente `route-search-service` con `search-redis`.
- **Environment:**
- **Response:**
- **Response measure:**
...
_Pendiente: completar escenario de rendimiento del patrón definido por el equipo (Cache-Aside) con métricas de latencia cache hit vs cache miss._
...
| Escenario 2 – Rendimiento del Patrón del Equipo         | Cache-Aside Pattern         | _Pendiente:_ el servicio de búsqueda utilizará Redis para reducir latencia en consultas repetidas.                                 |
